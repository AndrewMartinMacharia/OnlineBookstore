...
3. Create a database for the project called "project".
3. Unzip the Project file.
4. While using a terminal, go to the project's file location and enter "npm install" to install the modules.
